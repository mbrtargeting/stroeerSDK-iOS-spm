Pod::Spec.new do |spec|
  ...
  spec.license            = {
    :type => 'Commercial',
    :file => 'yieldlove-ad-integration-1.2.7/YieldloveAdIntegration/LICENSE'
  }
  ...
  spec.source             = {
    :http => 'https://raw.githubusercontent.com/mbrtargeting/stroeerSDK-iOS-spm/main/CocoaPods/1.2.7/yieldlove-ad-integration-1.2.7.zip'
  }
  ...
  spec.subspec 'Core' do |core|
    core.vendored_frameworks = [
      'yieldlove-ad-integration-1.2.7/YieldloveAdIntegration/Frameworks/YieldloveAdIntegration.xcframework'
    ]

    core.resource_bundles = {
      'YieldloveAdIntegration' => [
        'yieldlove-ad-integration-1.2.7/YieldloveAdIntegration/Resources/Core/dashboard.html',
        'yieldlove-ad-integration-1.2.7/YieldloveAdIntegration/Resources/Core/debuginfo.html',
        'yieldlove-ad-integration-1.2.7/YieldloveAdIntegration/Resources/Core/PrivacyInfo.xcprivacy'
      ]
    }
  ...
  spec.subspec 'Consent' do |consent|
    consent.vendored_frameworks = [
      'yieldlove-ad-integration-1.2.7/YieldloveAdIntegration/Frameworks/YieldloveAdIntegration_Consent.xcframework'
    ]

    consent.resource_bundles = {
      'YieldloveAdIntegrationConsent' => [
        'yieldlove-ad-integration-1.2.7/YieldloveAdIntegration/Resources/Consent/PrivacyInfo.xcprivacy'
      ]
    }
  ...
  spec.subspec 'Confiant' do |confiant|
    confiant.vendored_frameworks = [
      'yieldlove-ad-integration-1.2.7/YieldloveAdIntegration/Frameworks/YieldloveAdIntegration_Confiant.xcframework'
    ]

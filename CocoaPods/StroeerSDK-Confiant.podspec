Pod::Spec.new do |spec|
  ...
  spec.license            = {
    :type => 'Commercial',
    :file => 'stroeer-sdk-0.0.7/StroeerSDK/LICENSE'
  }
  ...
  spec.source             = {
    :http => 'https://github.com/mbrtargeting/stroeerSDK-iOS-spm/releases/download/cocoapods-0.0.7/stroeer-sdk-0.0.7.zip'
  }
  ...
  spec.subspec 'Core' do |core|
    core.vendored_frameworks = [
      'stroeer-sdk-0.0.7/StroeerSDK/Frameworks/StroeerSDK.xcframework'
    ]

    core.resource_bundles = {
      'StroeerSDK' => [
        'stroeer-sdk-0.0.7/StroeerSDK/Resources/Core/dashboard.html',
        'stroeer-sdk-0.0.7/StroeerSDK/Resources/Core/debuginfo.html',
        'stroeer-sdk-0.0.7/StroeerSDK/Resources/Core/PrivacyInfo.xcprivacy'
      ]
    }
  ...
  spec.subspec 'Consent' do |consent|
    consent.vendored_frameworks = [
      'stroeer-sdk-0.0.7/StroeerSDK/Frameworks/StroeerSDK_Consent.xcframework'
    ]

    consent.resource_bundles = {
      'StroeerSDKConsent' => [
        'stroeer-sdk-0.0.7/StroeerSDK/Resources/Consent/PrivacyInfo.xcprivacy'
      ]
    }
  ...
  spec.subspec 'Confiant' do |confiant|
    confiant.vendored_frameworks = [
      'stroeer-sdk-0.0.7/StroeerSDK/Frameworks/StroeerSDK_Confiant.xcframework'
    ]

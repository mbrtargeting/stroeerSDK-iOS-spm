...
@property (nonatomic, copy) NSString * _Nullable burl;
...
/// \param uniqueId Cookie or platform-native identifier.
///
...
///
- (nonnull instancetype)initWithUniqueId:(NSString * _Nonnull)uniqueId aType:(NSNumber * _Nonnull)aType ext:(NSDictionary<NSString *, id> * _Nullable)ext OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
